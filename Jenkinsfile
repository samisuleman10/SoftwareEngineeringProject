    ...
    stages {
        stage('Build') {
            ...
            steps {
                ...
                sh 'python -m py_compile source/main.py'
        ...
        stage('Test') {
            ...
            steps {
                ...
                sh 'py.test --verbose --junit-xml test-reports/results.xml source/test_main.py'
            }
            post {
                always {
        ...
        stage('Deliver') {
                    ...
                    post {
                        success {
                            ...
                            archiveArtifacts "${env.BUILD_ID}/source/dist/main"
